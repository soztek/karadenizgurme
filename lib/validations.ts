...
export const settingsSchema = z.object({
  ...
  google_maps_url_2: z.string().trim().default(""),
  yandex_maps_url_2: z.string().trim().default(""),
  apple_maps_url_2: z.string().trim().default(""),
  direction_label_1: z.string().trim().default(""),
  direction_label_2: z.string().trim().default(""),
